...
function get_schema() {
	var sqlScript = coordinator.readFile('common_tests/testseqnames/init_schema.sql');
	return sqlScript;
	
}
function load_data(coordinator) {
	var sqlScript = coordinator.readFile('common_tests/testseqnames/init_data.sql');
