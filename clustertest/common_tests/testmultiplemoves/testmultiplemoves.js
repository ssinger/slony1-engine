...
function get_schema() {
	var sqlScript = coordinator.readFile('common_tests/testmultiplemoves/init_schema.sql');
	return sqlScript;
	
}
function load_data(coordinator) {
	var sqlScript = coordinator.readFile('common_tests/testmultiplemoves/init_data.sql');
