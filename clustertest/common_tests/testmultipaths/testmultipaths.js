...
function get_schema() {
	var sqlScript = coordinator.readFile('common_tests/testmultipaths/init_schema.sql');
	return sqlScript;
	
}
function load_data(coordinator) {
	var sqlScript = coordinator.readFile('common_tests/testmultipaths/init_data.sql');
