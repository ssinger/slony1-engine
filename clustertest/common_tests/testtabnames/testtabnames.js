...
function get_schema() {
	var sqlScript = coordinator.readFile('common_tests/testtabnames/init_schema.sql');
	return sqlScript;
	
}
function load_data(coordinator) {
	var sqlScript = coordinator.readFile('common_tests/testtabnames/init_data.sql');
...
function init_tables() {
	var script=	coordinator.readFile('tests/common_tests/testtabnames/init_add_tables.ik');
