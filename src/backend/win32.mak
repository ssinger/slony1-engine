...
CPP_FLAGS=/c /D MSVC /D WIN32 /D PGSHARE=\"$(PGSHARE)\" /I..\misc /I..\..\ /I$(PG_INC) /I$(PG_INC)\server  /I$(PG_INC)\server\port\win32_msvc /I$(PG_INC)\server\port\win32 /I$(GETTEXT_INC) /D HAVE_LL_CONSTANTS=1 /D HAVE_GETACTIVESNAPSHOT /D PG_VERSION_MAJOR=$(PGVER) /LD /Gd /Tc 
