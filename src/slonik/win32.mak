...
LINK32_FLAGS=/libpath:$(PG_LIB) libpq.lib libpgport.lib /libpath:$(GETTEXT_LIB) intl.lib
OBJS = slonik.obj \
	dbutil.obj \
	parser.obj \
...
CPP_FLAGS=/c /D MSVC /D WIN32 /D PGSHARE=\"$(PGSHARE)\" /D YY_NO_UNISTD_H /I..\..\ /I$(PG_INC) /I$(PG_INC)\server /I$(PG_INC)\server\port\win32 /MD
