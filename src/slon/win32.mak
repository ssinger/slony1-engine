...
LINK32_FLAGS=/libpath:c:\postgresql\9.0\lib libpq.lib libpgport.lib /libpath:$(PTHREADS_LIB) pthreadVC2.lib wsock32.lib kernel32.lib user32.lib advapi32.lib /libpath:c:\gettext\lib intl.lib
OBJS = 	slon.obj		\
	runtime_config.obj	\
	local_listen.obj	\
	remote_listen.obj	\
